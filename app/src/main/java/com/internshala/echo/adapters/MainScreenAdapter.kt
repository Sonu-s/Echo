 ...
 */
class MainScreenAdapter(_songsDetails:ArrayList<Songs>,_context:Context):RecyclerView.Adapter<MainScreenAdapter.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.contentHolder?.setOnClickListener({
            ...
            (mContext as FragmentActivity).supportFragmentManager
                    ...
                    .addToBackStack("SongPlyingFragment")
                    .commit()
        })
